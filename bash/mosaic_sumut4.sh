#!/bin/bash
#
# Auto-generated mosaic script for sumut4
# Scenes filtered by GeoJSON boundary and clustered spatially
#

# Configuration
OTB_MOSAIC="/Users/macbook/OTB-8.1.2-Darwin64/bin/otbcli_Mosaic"
INPUT_DIR="/Volumes/Extreme SSD/00_Sumatera/Planetscope"
OUTPUT_DIR="/Volumes/Extreme SSD/00_Sumatera/Planetscope/mosaic_sumut4"

# Create output directory
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "PlanetScope Mosaic - sumut4"
...
# cluster_1: 5 scenes (cloud cover: 50% -> 0%)
