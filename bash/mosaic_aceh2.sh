#!/bin/bash
#
# Auto-generated mosaic script for aceh2
...
OUTPUT_DIR="/Volumes/Extreme SSD/00_Sumatera/Planetscope/mosaic_aceh2"

# Create output directory
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "PlanetScope Mosaic - aceh2"
...
# cluster_1: 10 scenes (cloud cover: 43% -> 0%)
